...
var Kepegawaian = {
  crudCuti: function crudCuti(req, res) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            path = '/api/kepegawaian/crudCuti';
            method = 'POST';
            findOneQuery = "select * from eoffice.cuti_crud  ($1,$2,$3,$4,$5::json)";
  ...
  crudLapHarian: function crudLapHarian(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var ip, path, method, findOneQuery, _yield$db$query2, rows, rowCount, data, data_pegawai;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/kepegawaian/crudLapHarian';
            method = 'POST';
          ...
          case 15:
            data = rows[0].data;
            data_pegawai = rows[0].data_pegawai;
  ...
  crudLapHarianTTE: function crudLapHarianTTE(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/kepegawaian/crudLapHarianTTE';
            method = 'POST';
            findOneQuery = "select * from eoffice.lap_harian_tte_crud  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context3.prev = 5;
            _context3.next = 8;
            return _db["default"].query(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  getAbsensiTemp: function getAbsensiTemp(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/kepegawaian/getAbsensiTemp';
            method = 'POST';
            findOneQuery = "select * from eoffice.absen_temp_get  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context4.prev = 5;
            _context4.next = 8;
            return _db["default"].query(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  getAbsensiTemp_v2: function getAbsensiTemp_v2(req, res) {
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            ...
            path = '/api/kepegawaian/getAbsensiTemp';
            method = 'POST';
            findOneQuery = "select * from eoffice.absen_v2_temp_get  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context5.prev = 5;
            _context5.next = 8;
            return _db["default"].query(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  crudAbsensi: function crudAbsensi(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/kepegawaian/crudAbsensi';
            method = 'POST';
            findOneQuery = "select * from eoffice.absensi_crud  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context6.prev = 5;
            _context6.next = 8;
            return _db["default"].query(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  crudAbsensiv2: function crudAbsensiv2(req, res) {
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            ...
            path = '/api/kepegawaian/crudAbsensi';
            method = 'POST';
            findOneQuery = "select * from eoffice.absensi_crud_v2  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context7.prev = 5;
            _context7.next = 8;
            return _db["default"].query(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  cekSaldoCuti: function cekSaldoCuti(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/kepegawaian/cek_saldo_cuti';
            method = 'POST';
            findOneQuery = "select * from eoffice.cek_saldo_cuti  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context8.prev = 5;
            _context8.next = 8;
            return _db["default"].query(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  crudSkpKpKgb: function crudSkpKpKgb(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
      ...
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/kepegawaian/crudSkpKpKgb';
            method = 'POST';
            findOneQuery = "select * from eoffice.skp_kp_kgb_crud  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context9.prev = 5;
            _context9.next = 8;
            return _db["default"].query(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  crudUangMakan: function crudUangMakan(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
      var ip, path, method, findOneQuery, _yield$db$query10, rows, rowCount, data;
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/kepegawaian/crudUangMakan';
            method = 'POST';
            findOneQuery = "select * from eoffice.uang_makan_crud  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context10.prev = 5;
            _context10.next = 8;
            return _db["default"].query(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  getUangMakanTemp: function getUangMakanTemp(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
      var ip, path, method, findOneQuery, _yield$db$query11, rows, rowCount, data;
      return _regeneratorRuntime().wrap(function _callee11$(_context11) {
        while (1) switch (_context11.prev = _context11.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/kepegawaian/getUangMakanTemp';
            method = 'POST';
            findOneQuery = "select * from eoffice.uang_makan_temp_get  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context11.prev = 5;
            _context11.next = 8;
            return _db["default"].query(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  crudTukin: function crudTukin(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee12() {
      var ip, path, method, findOneQuery, _yield$db$query12, rows, rowCount, data;
      return _regeneratorRuntime().wrap(function _callee12$(_context12) {
        while (1) switch (_context12.prev = _context12.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/kepegawaian/crudTukin';
            method = 'POST';
            findOneQuery = "select * from eoffice.tukin_crud  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context12.prev = 5;
            _context12.next = 8;
            return _db["default"].query(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  crudLKHTarget: function crudLKHTarget(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee13() {
      ...
      return _regeneratorRuntime().wrap(function _callee13$(_context13) {
        while (1) switch (_context13.prev = _context13.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/kepegawaian/lkh/target';
            method = 'POST';
            findOneQuery = "select * from eoffice.t_laporan_harian_target_crud  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context13.prev = 5;
            _context13.next = 8;
            return _db["default"].query(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  crudLKHRealisasi: function crudLKHRealisasi(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee14() {
      ...
      return _regeneratorRuntime().wrap(function _callee14$(_context14) {
        while (1) switch (_context14.prev = _context14.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/kepegawaian/lkh/realisasi';
            method = 'POST';
            findOneQuery = "select * from eoffice.t_laporan_harian_realisasi_crud  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context14.prev = 5;
            _context14.next = 8;
            return _db["default"].query(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  crudKetidakhadiran: function crudKetidakhadiran(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee15() {
      ...
      return _regeneratorRuntime().wrap(function _callee15$(_context15) {
        while (1) switch (_context15.prev = _context15.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/kepegawaian/ketidakhadiran';
            method = 'POST';
            findOneQuery = "select * from eoffice.t_laporan_absen_crud  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context15.prev = 5;
            _context15.next = 8;
            return _db["default"].query(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  crudPengaduanAbsensi: function crudPengaduanAbsensi(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee16() {
      ...
      return _regeneratorRuntime().wrap(function _callee16$(_context16) {
        while (1) switch (_context16.prev = _context16.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/kepegawaian/pengaduanAbsensi';
            method = 'POST';
            findOneQuery = "select * from eoffice.t_pengaduan_absen_crud  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context16.prev = 5;
            _context16.next = 8;
            return _db["default"].query(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  crudCuti2: function crudCuti2(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee17() {
      ...
      return _regeneratorRuntime().wrap(function _callee17$(_context17) {
        while (1) switch (_context17.prev = _context17.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/kepegawaian/cuti';
            method = 'POST';
            findOneQuery = "select * from eoffice.t_cuti_crud  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context17.prev = 5;
            _context17.next = 8;
            return _db["default"].query(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  jenisCuti: function jenisCuti(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee18() {
      ...
      return _regeneratorRuntime().wrap(function _callee18$(_context18) {
        while (1) switch (_context18.prev = _context18.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/kepegawaian/jenisCuti';
            method = 'POST';
            findOneQuery = "select * from eoffice.get_ddl_jenis_cuti2 ()";
  ...
  ddlJenisCuti: function ddlJenisCuti(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee19() {
      var findOneQuery, _yield$db$query19, rows, rowCount;
...
var _default = exports["default"] = Kepegawaian;