...
var Humas = {
  crudAgendaPimpinan: function crudAgendaPimpinan(req, res) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            path = '/api/humas/agenda_pimpinan/crud';
            method = 'POST';
            findOneQuery = "select * from eoffice.agenda_pimpinan_crud  ($1,$2,$3,$4,$5::json)";
  ...
  dashboardAgendaPimpinan: function dashboardAgendaPimpinan(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/humas/dashboard_agenda_pimpinan';
            method = 'GET';
            findOneQuery = "select * from eoffice.get_dashboard_agenda_pimpinan  ($1,$2,$3,$4)"; // console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
            _context2.prev = 4;
            _context2.next = 7;
...
var _default = exports["default"] = Humas;