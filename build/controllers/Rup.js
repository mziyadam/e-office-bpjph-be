...
var Rup = {
  crudRup: function crudRup(req, res) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            path = '/api/web/rup/crud';
            method = 'POST';
            findOneQuery = "select * from eoffice.rup_crud  ($1,$2,$3,$4,$5::json)";
  ...
  crudRup2: function crudRup2(req, res) {
  ...
  getDetailDdl: function getDetailDdl(req, res) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            findOneQuery = "select * from eoffice.ddl_detail($1::smallint)";
  ...
  getWilayahDdl: function getWilayahDdl(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
      var findOneQuery, _yield$db$query4, rows, rowCount;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            /// ddl header untuk web
            findOneQuery = "select * from eoffice.get_ddl_wilayah($1,$2)";
            console.log(findOneQuery, [req.body.id_daerah, req.body.level]);
            _context4.prev = 2;
            _context4.next = 5;
            return _db["default"].query(findOneQuery, [req.body.id_daerah, req.body.level]);
          case 5:
  ...
  getPengangkatanDdl: function getPengangkatanDdl(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            /// ddl header untuk web
            findOneQuery = "select * from eoffice.get_ddl_pengangkatan()"; //console.log(findOneQuery, [req.body.id_daerah, req.body.level]);
            _context5.prev = 1;
            _context5.next = 4;
  ...
  getApprovalDdl: function getApprovalDdl(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
      var param, findOneQuery, _yield$db$query6, rows, rowCount, data;
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            ...
            findOneQuery = "select * from eoffice.f_rup_approval('','','','',$1::json)";
            console.log(findOneQuery, [param]);
            _context6.prev = 3;
            _context6.next = 6;
            return _db["default"].query(findOneQuery, [param]);
          case 6:
    ...
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/web/rup/approval';
            method = 'POST';
            findOneQuery = "select * from eoffice.f_rup_approval  ($1,$2,$3,$4,$5::json)";
            console.log(findOneQuery, [ip, path, method, req.user.nip, JSON.stringify(req.body)]);
  ...
  getPokjaDdl: function getPokjaDdl(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            /// ddl header untuk web
            findOneQuery = "select * from eoffice.get_ddl_pokja($1)";
            console.log(findOneQuery, [req.params.tahun]);
            _context8.prev = 2;
            _context8.next = 5;
            return _db["default"].query(findOneQuery, [req.params.tahun]);
          case 5:
  ...
  getDashboardData: function getDashboardData(req, res) {
      ...
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          case 0:
            /// ddl header untuk web
            ip = req.headers['x-forwarded-for'] || req.connection.remoteAddress;
            path = '/api/web/get_dashboard_data';
            method = 'GET';
            findOneQuery = "select * from eoffice.get_dashboard_data($1,$2,$3,$4)";
          ...
          case 15:
            data = JSON.parse(JSON.stringify(rows[0].data));
            return _context9.abrupt("return", res.status(200).send({
              'RC': '00',
              'message': 'Sukses',
              data: data
  ...
  getLokasiPekerjaanDdl: function getLokasiPekerjaanDdl(req, res) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          case 0:
            /// ddl header untuk web
            findOneQuery = "select * from eoffice.get_ddl_lokasi_rup($1)";
            console.log(findOneQuery, [req.params.id_rup]);
            _context10.prev = 2;
            _context10.next = 5;
            return _db["default"].query(findOneQuery, [req.params.id_rup]);
          case 5:
...
var _default = exports["default"] = Rup;