...
var Auth = {
   ...
   */
  verifyTokenWeb: function verifyTokenWeb(req, res, next) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var token, decoded, text, _yield$db$query, rows;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            token = req.headers['x-access-key']; // console.log(JSON.stringify(req.headers))
            if (token) {
              _context.next = 3;
              break;
            }
          ...
          case 6:
            ...
            //console.log(decoded);
            text = 'SELECT * FROM eoffice.users WHERE nip = $1'; // console.log(decoded);
            _context.next = 10;
          ...
          case 14:
            req.user = {
              nip: decoded.userId,
              satker_id: decoded.unkerId,
              jabatan_id: decoded.jabatanId,
              nik: decoded.nik
            };
